# Show average temperature in comparison with DWD values per hour
...
png("generated/412_avg_temp_dwd_by_hour.png", width=1000, height=600)
ggplot(data=mdata, aes(x=hour,y=value,colour=variable, linetype=variable)) + 
  geom_line() +
  ggtitle("Durchschnittstemperatur deutscher Messstationen im Vergleich mit DWD-Aussentemperaturen pro Stunde")+
