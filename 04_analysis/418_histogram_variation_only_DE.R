# Show the amount of Min-Max temperature ranges in germany only
library(RMySQL)
library(ggplot2)
library(scales)
...
png("generated/418_histogram_variation_only_DE.png", width=1000, height=600)
ggplot(data=data, aes(data$diff)) + 
  geom_histogram(bins=60, fill="#56B4E9") +
  ggtitle("Anzahl der Differenzen der Temperatur pro Messstation in Deutschland")+    
